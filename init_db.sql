...
-- Наполнение демонстрационными данными (расширенный сценарий)
INSERT INTO subscriptions (customer_id, membership_start_date, membership_end_date, membership_status) 
VALUES
    -- Клиент 115: Базовый сценарий (Free -> Paid -> Non-member пауза -> Paid)
    ...
    -- Клиент 116: Короткий цикл (Free -> Paid -> Окончательный Churn)
    ('116', '2020-05-01', '2020-06-01', 'Free'),
    ('116', '2020-06-01', '2020-09-01', 'Paid'),

    -- Клиент 117: Прямой платный старт и продление (Paid -> Paid -> Churn)
    ('117', '2020-01-15', '2020-02-15', 'Paid'),
    ('117', '2020-02-15', '2020-03-15', 'Paid'),

    -- Клиент 118: Бесплатное продление с паузой и платным возвратом (Free -> Free -> Non-member -> Paid)
